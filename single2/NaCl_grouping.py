...
SaveMD('md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_data_MDE0.nxs')
SaveMD('van_md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_van_MDE0.nxs')
...
norm = mdh/van_mdh
SaveMD('mdh', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_data_MDH0.nxs')
SaveMD('van_mdh', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_van_MDH0.nxs')
SaveMD('norm', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_norm_MDH0.nxs')
