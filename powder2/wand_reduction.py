...
AddSampleLog(van, LogName='HB2C:Mot:s2', LogText='16.0249', LogType='Number Series')
AddSampleLog(van, LogName='HB2C:Mot:detz', LogText='-0.0047', LogType='Number Series')
...
AddSampleLog(si, LogName='HB2C:Mot:s2', LogText='16.0249', LogType='Number Series')
AddSampleLog(si, LogName='HB2C:Mot:detz', LogText='-0.0047', LogType='Number Series')
