...
createWS_alg = mantid.api.PythonAlgorithm.createChildAlgorithm("CreateMDHistoWorkspace", enableLogging=False)
createWS_alg.setProperty("SignalInput", data_array)
createWS_alg.setProperty("ErrorInput", data_array)
createWS_alg.setProperty("Dimensionality", 3)
createWS_alg.setProperty("Extents", '{},{},0.5,512.5,0.5,3840.5'.format(phi_array[0],phi_array[-1]))
createWS_alg.setProperty("NumberOfBins", '{},{},0.5,512.5,0.5,3840.5'.format(phi_array[0],phi_array[-1]))
createWS_alg.setProperty("Names", 'phi,x,y')
