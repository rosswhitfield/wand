...
for run in range(4756,6558,1):
    ...
    BinMD(InputWorkspace='van_md', OutputWorkspace='van_mdh',  AlignedDim0='[H,0,0],-8,8,401', AlignedDim1='[0,K,0],-8,8,401', AlignedDim2='[0,0,L],-2.5,2.5,126')
    if 'data' in mtd:
    ...
    if run%100 == 0:
        SaveMD('data', '/HFIR/HB2C/IPTS-7776/shared/rwp/PNO_data_MDH_HKL_T.nxs')
        SaveMD('norm', '/HFIR/HB2C/IPTS-7776/shared/rwp/PNO_van_MDH_HKL_T.nxs')
