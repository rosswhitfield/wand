...
SaveNexus('van','/SNS/users/rwp/wand/HB2C_2933_Van_processed_grouped_rect.nxs')
...
for run in range(2952,4754,1):
    ...
    if run%100 == 0:
        SaveMD('md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_data_rect_MDE.nxs')
        SaveMD('van_md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_van_rect_MDE.nxs')
