...
RemoveLogs('van', KeepLogs="HB2C:Mot:s1")
"""
...
for run in range(2952,4754,1):
    ...
    if run%100 == 0:
        SaveMD('md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_data_MDE.nxs')
        SaveMD('van_md', '/HFIR/HB2C/IPTS-7776/shared/rwp/NaCl_van_MDE.nxs')
